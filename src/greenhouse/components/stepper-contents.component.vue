...
export default {
  ...
  data() {
    return {
      ...
      isLastPhase: false,
      phases: [
        {label: '0', message: 'Insumos', endpoint: 'stock?'},
        {label: '1', message: 'Patio', endpoint: 'preparation_area?'},
        {label: '2', message: 'Búnker', endpoint: 'bunker?'},
        {label: '3', message: 'Túnel', endpoint: 'tunnel?'},
        {label: '4.1', message: 'Incubación', endpoint: 'grow_room_record?processType=Incubation&&'},
        {label: '4.2', message: 'Cobertura', endpoint: 'grow_room_record?processType=Casing&&'},
        {label: '4.3', message: 'Inducción', endpoint: 'grow_room_record?processType=Induction&&'},
        {label: '4.4', message: 'Cosecha', endpoint: 'grow_room_record?processType=Harvest&&'},
      ],
      record: "",
      phaseMapping: {
        'Stock': 0,
